...
<!-- Edit Product Modal -->
<div class="modal" id="EditCustomFieldModal">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content shadow-lg p-3 mb-5 bg-white rounded">
            <!-- Modal Header -->
            <div class="modal-header">
                <h5 class="modal-title">{{ __('lang.edit_custom_field') }}</h5>
            ...
            <div class="modal-body">
                ...
                <div id="EditCustomFieldModalBody">

                </div>
            </div>
            <!-- Modal footer -->
            <div class="modal-footer">
                <button type="button" class="btn btn-success" id="SubmitEditCustomFieldForm">{{ __('lang.update') }}</button>
...
<div class="modal" id="DeleteCustomFieldModal">
...
@section('js')
    ...
    <script src="{{ asset('assets/js/customFieldDataTable.js') }}"></script>
@endsection