...
Route::group(['middleware' => ['auth','locale']], function() {
    ...
    Route::post('update-ticket-jira/{id}', 'TicketsController@updatejira')->name('update-ticket-jira.update');
    ...
    //ticket export
    Route::get('tickets/export-all/', 'TicketsController@exportAll')->name('export-all-ticket');
    Route::get('tickets/export-opened/', 'TicketsController@exportOpen')->name('export-opened-ticket');
